  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-1/2 md:ml-4">
        <h1 className="font-bold text-4xl text-light-text dark:text-light text-left xl:text-7xl xl:mb-10">
        ...
        <p className="text-base text-left my-4 text-light-text dark:text-light md:max-lg:text-xl xl:text-3xl xl:leading-10">
